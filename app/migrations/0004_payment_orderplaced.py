# Generated by Django 4.2.6 on 2023-11-08 14:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Cancel', 'Cancel'), ('Accepted', 'Accepted'), ('On The Way', 'On The Way'), ('Delivered', 'Delivered'), ('Packed', 'Packed'), ('Pending', 'Pending')], default='Pending', max_length=50)),
